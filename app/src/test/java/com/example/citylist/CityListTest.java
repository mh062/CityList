...
public class CityListTest {
    ...
    @Test
    public void testdelete()   //i)testdelete method
    {
        CityList cityList = new CityList();
        City city= new City("Khulna","Jessore");
        City city1= new City("Mym","Dhaka");
        cityList.add(city);
        cityList.add(city1);
    ...
    @Test
    public void testDeleteException()  //ii)testDeleteException
    {
        CityList cityList = new CityList();
        City city= new City("Khulna","Jessore");
        City city1= new City("Mym","Dhaka");
        cityList.add(city);
        cityList.add(city1);
        assertEquals(2,cityList.count());   // iv) testcount
    ...
    public void testGetCities() {
        CityList cityList = new CityList();
        City city2= new City("Gajiput","Dhaka");
        cityList.add(city2);
